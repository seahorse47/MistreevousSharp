...
{
    /// <summary>
    /// Creates a new instance of the Succeed class.
    /// </summary>
    /// <param name="attributes">The node attributes.</param>
    /// <param name="options">The behaviour tree options.</param>
    /// <param name="child">The child node.</param>
    public Succeed(List<Attribute> attributes, BehaviourTreeOptions options, Node child)
        : base("succeed", attributes, options, child)
    {
    }
    ...
    /// </summary>
    public override string GetName() => "SUCCEED";
}
